...
export const db_getContainers = async () => {
	return await query("SELECT codigo as ContainerId, fecha as StartLoadingDate, fecha_salida  as EndLoadingDate, master as Master, paquetes as ProductsQuantity,peso as Weight, sello as SealedNumber, estado as State FROM contenedores LIMIT 50");
};
